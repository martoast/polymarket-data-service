...
<div class="min-h-[calc(100vh-8rem)] flex items-center justify-center px-4 py-12">
    <div class="w-full max-w-sm">
        ...
        {{-- Header --}}
        <div class="mb-8">
            <h1 class="text-2xl font-mono font-bold text-white">Sign in</h1>
            <p class="text-gray-500 font-mono text-sm mt-1">Access your API dashboard</p>
        </div>
        ...
        <form method="POST" action="{{ route('login') }}" class="space-y-4">
            ...
            <div class="flex items-center justify-between">
                <label class="flex items-center gap-2 cursor-pointer">
                    <input type="checkbox" name="remember" class="accent-[#22c55e]" />
                    <span class="text-xs font-mono text-gray-400">Remember me</span>
                </label>
            </div>
        ...
        <p class="text-center text-sm font-mono text-gray-500 mt-6">
            No account?
            <a href="{{ route('register') }}" class="text-[#22c55e] hover:text-green-400 transition-colors">Create one</a>
        </p>
